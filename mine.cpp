...
void game()
{
    ...
    game_time=time(0);
    print_table(table);
    if(turn%4==0)cout<<"Turn P1:";
    else if(turn%4==1)cout<<"Turn P2:";
    else if(turn%4==2)cout<<"Turn P3:";
    else if(turn%4==3)cout<<"Turn P4:";
    open_cell(turn);
    turn++;
    if(game_lose_p1&&turn%4==0){
	turn++;
    }
    if(game_lose_p2&&turn%4==1){
	turn++;
    }
    if(game_lose_p3&&turn%4==2){
	turn++;
    }
    if(game_lose_p4&&turn%4==3){
	turn++;
    }
	}
